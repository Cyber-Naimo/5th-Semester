    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <p>Experience the best in hospitality and make your reservation now. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt uttersi labore et dolore magna aliqua is ipsum suspendisse ultrices gravida.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="info-item">
            ...
            <a href="#">muhammadnaimatullahkhan99@email.com</a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
          <div class="info-item">
            ...
            <a href="#">24th Street North Karachi,  Pakistan</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                  <fieldset>
                      ...
                      <input type="text" name="name" class="Name" placeholder="Ex. Mohsin Khan" autocomplete="on" >
                  </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="Number" class="form-label">Your Phone Number</label>
                    <input type="text" name="phone_number" class="Number" placeholder="Ex. 03162604957" autocomplete="on" >
                </fieldset>
              </div>
              <div class="col-lg-6">
                  <fieldset>
