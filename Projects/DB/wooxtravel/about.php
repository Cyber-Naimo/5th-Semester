      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading text-center">
            ...
            <p>Discover exciting weekly promotions and deals in your favorite cities.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="section-heading">
            ...
            <p>Learn about the rich culture, history, and attractions that our country has to offer.</p>
          </div>
          <div class="row">
          ...
          <p>Welcome to our website! We are dedicated to providing you with the best information and services. Explore our offerings and discover the possibilities.</p>
